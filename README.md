# Voting Time Step Classifier in Scikit-learn

Voting Time Step Classification Model in Scikit-learn as per Ready Tensor specifications.
...
- A **Voting Time Step Classification** model built using **Scikit-learn**
